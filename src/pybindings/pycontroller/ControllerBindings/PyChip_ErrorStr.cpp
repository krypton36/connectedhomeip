...
void bind_PyChip_ErrorStr(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("chip").def("ErrorStr", (const char * (*)(CHIP_ERROR)) &chip::ErrorStr, "C++: chip::ErrorStr(unsigned int) --> const char *", pybind11::return_value_policy::automatic, pybind11::arg("err"));
	...
	M("chip").def("FormatError", (void (*)(char *, unsigned short, const char *, unsigned int, const char *)) &chip::FormatError, "C++: chip::FormatError(char *, unsigned short, const char *, unsigned int, const char *) --> void", pybind11::arg("buf"), pybind11::arg("bufSize"), pybind11::arg("subsys"), pybind11::arg("err"), pybind11::arg("desc"));
