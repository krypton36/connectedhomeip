...
##### Property: [_{variable\_name}_](#yaml-config-variables-example)
| Name     | Description                                                                           |
| -------- | ------------------------------------------------------------------------------------- |
...
##### Property: [_arguments_](#yaml-tests-example)
...
## List: _chip\_tests\_item\_parameters_
...
## List: _chip\_tests\_item\_response\_parameters_

**{{chip\_tests\_item\_response\_parameters}}** can be used inside a
**{{chip\_test\_items}}** block and iterates over the test response arguments for
the target command.
...
## List: _chip\_tests\_pics_

**{{chip\_tests\_pics}}** can be used to get the collection of all PICS for a givin test.

## List: _chip\_tests\_config_

**{{chip\_tests\_config}}** can be used to get the collection of user defined variables in the config. See [ZAP Tests Config](#examples) below
...
YAML is used to generate tests into a programming language understood by commissioners, controllers, or simulated devices. There is a define set of keword/values that are used to define test behavior. 

YAML is the high level language chosen to generate test against a controller or a controllee. [Test Definition Example](#yaml-tests-example)
...
- Simulated tests: [tests.js](../../../../examples/placeholder/linux/apps/app1/tests.js)

- chip-tool(darwin) tests: [tests.js](../../../../examples/chip-tool-darwin/templates/tests.js)

- chip-tool tests: [tests.js](../../../../examples/chip-tool/templates/tests.js)
